...
//            Toast.toastLong("Go to app settings to grant requested permission.");
    ...
    /**
     * Build a {@link Map} of request codes.  We use an {@link android.support.v4.util.ArrayMap},
    ...
    private static Map<String, Integer> buildRequestCodeMap() {
        Map<String, Integer> requestCodeMap = new android.support.v4.util.ArrayMap<>();
     ...
     * the requested permissions and notifies the {@link RuntimePermissionsHelper.Listener}.
    ...
    public interface Listener {
         ...
         * implementing {@link RuntimePermissionsHelper.Listener}, can then
        ...
        /**
         * Called when the {@link RuntimePermissionsHelper.Listener} needs
